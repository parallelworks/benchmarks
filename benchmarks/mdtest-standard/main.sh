...
echo "mpirun -ppn $SLURM_CPUS_ON_NODE ${benchmark_dir}/mdtest -n 20840 -e 4096 -w 4096 -i 3 -u -d ${benchmark_dir}"
mpirun -ppn $SLURM_CPUS_ON_NODE ${benchmark_dir}/mdtest -n 20840 -e 4096 -w 4096 -i 3 -u -d ${benchmark_dir}
